            ...
            <div className='container'>
              ...
              <div className="">
                ...
                <div className='d-flex justify-content-between'>
                  <div>
                <p id='libre' className='display-4 mt-5 text-secondary-emphasis'>Quality Prints</p>
                <p className='fs-4 fw-bold' style={{color:"#708097"}}>Shipped to your doorstep</p>
                <p className='mt-5 fw-bold'>what would you like to print today?</p>
                <input  type="search" placeholder='Search for Business cards, T-shirts, Mugs, etc'  className='w-100 rounded border col-md-12 p-4 position-relative'/>
                  </div>
                  <div>
              <img className='w-80 mt-5  d-none d-lg-block' src="printivo hand.JPG" alt="" />
                  </div>
                </div>
            </div>
        </div>

        <div style={{backgroundColor: "#f2b1cc"}} className="p-4 text-center col-md-12">
        <strong className='fw-bold p-2 mt-5 mb-5'>Tote </strong><a href="" className=' text-dark'>Shop Now</a>
      </div>
    </>
  )
}
