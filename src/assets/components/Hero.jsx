        ...
        <div className='mainBody'>
            <div className='container'>
              <div className="d-flex justify-content-between">
                ...
                <input  style={{width:"150%"}} type="search" placeholder='Search for Business cards, T-shirts, Mugs, etc'  className='rounded border p-4 position-relative'/><i className='bi bi-search'></i>
                  </div>
                  <div>
              <img className='w-75 mt-5 ms-5 float-end ms-5 ' src="printivo hand.JPG" alt="" />
                  </div>
                </div>
            </div>
        </div>
